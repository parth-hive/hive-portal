...
export function ListingActionSelector({
  ...
  return (
    <select
      ...
      className={`cursor-pointer appearance-none rounded-full border px-2 py-0.5 pr-5 text-[10px] font-medium uppercase tracking-wide transition disabled:opacity-60 ${ACTION_PILL[current]}`}
      style={{
        backgroundImage:
